...
const Header = () => {
    return (
        <div className='background flex flex-col items-center'>
            ...
            <div className="text-center text-white xs:text-[10px] sm:text-[14px] md:text-[18px] lg:text-[24px] font-Inter l">The latest in generative AI with a transparent pricing model<br /> that scales with your needs.</div>
